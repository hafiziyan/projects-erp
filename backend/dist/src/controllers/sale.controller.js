...
const createSaleSchema = zod_1.z.object({
    paymentMethod: zod_1.z.string().min(1, 'Metode pembayaran wajib diisi'),
    discountAmount: zod_1.z.union([zod_1.z.string(), zod_1.z.number()]).optional(),
...
async function createSale(req, res) {
    try {
        ...
        const saleDetail = await prisma_1.prisma.sale.findUnique({
            where: {
                id: result.id,
            },
            include: {
